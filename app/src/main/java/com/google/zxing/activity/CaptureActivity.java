...
import com.tzb.bcmrs.util.BitmapUtil;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewfinderView = (ViewfinderView) findViewById(R.id.activity_scanner_viewfinder_content);
        back = (ImageButton) findViewById(R.id.activity_scanner_btn_back);
        ...
        btnFlash = (ImageButton) findViewById(R.id.activity_scanner_btn_flash);
        btnFlash.setOnClickListener(flashListener);

        btnAlbum = (Button) findViewById(R.id.activity_scanner_btn_album);
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    protected void onResume() {
        super.onResume();
        SurfaceView surfaceView = (SurfaceView) findViewById(R.id.activity_scanner_view);
...
//            Logger.d("saomiao",resultString);
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        try {
            ...
            findViewById(R.id.activity_scanner_tip).setVisibility(View.GONE);
        } catch (IOException ioe) {
            findViewById(R.id.activity_scanner_tip).setVisibility(View.VISIBLE);
            return;
